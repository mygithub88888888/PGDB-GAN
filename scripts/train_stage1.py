...
fh = logging.FileHandler(os.path.join(args.save, './train_results/trainlogtxt.txt'))
...
def main():
    ...
    train_low_data_names = './datasets/data_choose/image'
    TrainDataset = DataLoader(img_dir=train_low_data_names, task='train')



    test_low_data_names = './datasets/data_choose/image'
